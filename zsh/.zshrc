...
# Functions : 
z () {
  cd ~/work/"$1" || echo "Dir not found $1"
}
...
alias activatePostgre="sudo systemctl start postgresql"
alias stopPostgre="sudo systemctl stop postgresql"
alias loginPostgre="sudo -i -u postgres"
